...
%% Gestures
    ...
    for j=1:length(user)
        ...
        for i_session = sessions
            ...
            filename = ['C:\Users\aleks\Google Drive\Università\NearLab\gesture_rcn\Training_Set\transcriptions/',user(j),num2str(00),num2str(i_session),'.txt'];
    ...
    %% Pairing Gestures to real data
        ...
        u = ['u',int2str(j)];
            for i_session = sessions
                s = ['s',int2str(i_session)];
                filename = ['C:\Users\aleks\Google Drive\Università\NearLab\gesture_rcn\Training_Set/',user(j),num2str(00),num2str(i_session),'.txt'];
